...
func (*ProtoBufA) Descriptor() ([]byte, []int) {
	return fileDescriptor_3829f236e6ac66c8, []int{0}
}
...
func (m *ProtoBufA) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtoBufA.Merge(m, src)
}
...
func init() { proto.RegisterFile("structdef.proto", fileDescriptor_3829f236e6ac66c8) }

var fileDescriptor_3829f236e6ac66c8 = []byte{
